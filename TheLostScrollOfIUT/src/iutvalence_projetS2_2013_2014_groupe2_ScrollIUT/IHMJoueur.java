...
public class IHMJoueur implements Runnable, KeyListener {
	...
	/**
	 * Affiche les d̩gats inflig̩s par le joueur.
	 * 
...
public void affichagePanneau(){
	...
	/**
	 * Selectionenr une r̩ponse parmis N choix
	 */
	...
	/**
	 * Verifie si la porte necessite une cl̩ pour etre ouverte
	 * 
	...
	/**
	 * Verifie si le coffre necessite une cl̩ pour etre ouvert
	 * 
	 * @return true, if successful
	 */
